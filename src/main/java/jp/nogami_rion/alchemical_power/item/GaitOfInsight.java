...
public class GaitOfInsight extends ArmorItem {
    public GaitOfInsight() {
        super(ModArmorMaterials.SINGULARITY, Type.LEGGINGS,
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "alchemical_power:models/armor/gait_of_insight.png";
    }
