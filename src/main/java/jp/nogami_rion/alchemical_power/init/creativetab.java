    ...
    static {
        ALCHEMICAL_POWER_TAB = TABS.register("alchemical_power_tab", () -> CreativeModeTab.builder()
                ...
                .displayItems((itemDisplayParameters, output) -> {
                    ...
                    output.accept(itemlist.HIGH_DENSITY_ALCHEMICAL_COPPER.get());
                    output.accept(itemlist.HIGH_DENSITY_ALCHEMICAL_IRON.get());
                    output.accept(itemlist.HIGH_DENSITY_ALCHEMICAL_GOLD.get());
                    output.accept(itemlist.HIGH_DENSITY_ALCHEMICAL_DIAMOND.get());
                    output.accept(itemlist.HIGH_DENSITY_ALCHEMICAL_EMERALD.get());
                    output.accept(itemlist.HIGH_DENSITY_ALCHEMICAL_NETHERITE.get());
