...
public class AlchemicalTablesTier1Screen  extends AbstractContainerScreen<AlchemicalPowerTables3x3Menu> {
    ...
    public AlchemicalTablesTier1Screen(AlchemicalPowerTables3x3Menu menu, Inventory playerInventory, Component title){
...
//        int iStringX = ((width - this.imageWidth) / 2) - font.width("block.alchemical_power.alchemy_table_re")/2;
//        guiGraphics.drawCenteredString(this.font, Component.translatable("block.alchemical_power.alchemy_table_re"), this.imageWidth / 2, 4, FONT_COLOR);
    ...
    private void renderCraftEffect(GuiGraphics guiGraphics) {
        ...
        guiGraphics.pose().mulPose(com.mojang.math.Axis.ZP.rotationDegrees(rotationOuter));
